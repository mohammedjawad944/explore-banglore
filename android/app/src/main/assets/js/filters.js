        ...
        placesToRender.forEach((place, index) => {
            ...
            card.innerHTML = `
                ...
                <div class="card-image-container" style="position:relative;overflow:hidden;border-radius:14px 14px 0 0;">
                    <img class="card-img" src="${localImageUrl}" alt="${place.name}" style="width:100%;height:200px;object-fit:cover;display:none;" onload="this.style.display='block'; var p=this.parentElement.querySelector('.img-placeholder'); if(p) p.style.display='none';" onerror="this.style.display='none';">
