...
window.openModal = function(placeId) {
    ...
    modalBody.innerHTML = `
        <div style="position:relative;width:100%;height:250px;overflow:hidden;">
            ...
            <img id="modal-image" src="${unsplashUrl}" alt="${place.name}" style="width:100%;height:250px;object-fit:cover;display:none;position:absolute;top:0;left:0;" onload="this.style.display='block'; document.getElementById('modal-image-placeholder').style.display='none';" onerror="this.style.display='none';">
        </div>
    ...
    // Try Wikipedia image as fallback for modal
    if (typeof fetchWikipediaImage === 'function') {
